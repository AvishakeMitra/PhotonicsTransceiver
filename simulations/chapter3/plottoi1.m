...
data = xlsread('TOI data 0 dBm laser 5 GHZ minus 7.979dBM PD power.xlsx');
...
Pdc_w = 2.536147e-8;    % DC power detected from photodiode (from sim.)
...
x1_5 =Prf_dbm(2); y1_5 = P5ghz_dbm(2);
x2_5 =Prf_dbm(4); y2_5 = P5ghz_dbm(4);
slope_5=(y1_5-y2_5)/(x1_5-x2_5);

xgen = linspace(min(Prf_dbm_th),max(Prf_dbm_th)*0.965,200);
y5gen = y1_5 + slope_5*(xgen-x1_5);

x1_15 =Prf_dbm(5); y1_15 = P15ghz_dbm(5);
x2_15 =Prf_dbm(12); y2_15 = P15ghz_dbm(12);
