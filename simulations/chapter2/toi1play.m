...
Pf_dbm_th = -98.0146+.9872*Prf_dbm_th;
P3f_dbm_th = -164.491+2.38267*Prf_dbm_th;

Pf_formula = 1 * 0.25e-9/2 * (2*besselj(1,2*B)).^2;
Pf_dbm_formula = 10*log10(Pf_formula)+30;

P3f_formula = 1 * 0.25e-9/2 * (2*besselj(3,2*B)).^2;
